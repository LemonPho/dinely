...
from backend.views.tables import tables as shared_tables
...
urlpatterns = [
    ...
    path("admin/get-plate-categories/", plates.get_plate_categories),
    ...
    path("admin/get-plates/", plates.get_plates),
    ...
    path("admin/get-table-areas/", shared_tables.get_table_areas),
    ...
    path("admin/get-tables/", tables.get_tables),
    ...
    path("admin/get-reservations/", reservations.get_reservations),
    ...
    path("user/get-table-areas/", shared_tables.get_table_areas),
]